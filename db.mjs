...
export const DateString = mod.DateString;
...
export const dateStringConversion = mod.dateStringConversion;
...
export const toISOString = mod.toISOString;
export const toUnixMs = mod.toUnixMs;
