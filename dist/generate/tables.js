...
config, queryFn) => {
    ...
    rows.forEach(row => {
        ...
        let selectableType = (_b = (_a = config.types[rel.name]) === null || _a === void 0 ? void 0 : _a[column]) !== null && _b !== void 0 ? _b : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "Selectable"), JSONSelectableType = (_d = (_c = config.types[rel.name]) === null || _c === void 0 ? void 0 : _c[column]) !== null && _d !== void 0 ? _d : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "JSONSelectable"), whereableType = (_f = (_e = config.types[rel.name]) === null || _e === void 0 ? void 0 : _e[column]) !== null && _f !== void 0 ? _f : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "Whereable"), insertableType = (_h = (_g = config.types[rel.name]) === null || _g === void 0 ? void 0 : _g[column]) !== null && _h !== void 0 ? _h : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "Insertable"), updatableType = (_k = (_j = config.types[rel.name]) === null || _j === void 0 ? void 0 : _j[column]) !== null && _k !== void 0 ? _k : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "Updatable");
