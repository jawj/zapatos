...
config, queryFn) => {
    ...
    rows.forEach(row => {
        ...
        let selectableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'Selectable'), JSONSelectableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'JSONSelectable'), whereableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'Whereable'), insertableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'Insertable'), updatableType = (0, pgTypes_1.tsTypeForPgType)(udtName, enums, 'Updatable');
