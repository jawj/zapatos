...
config, queryFn) => {
    ...
    rows.forEach(row => {
        ...
        let selectableType = (_c = (_b = (_a = config.types) === null || _a === void 0 ? void 0 : _a[rel.name]) === null || _b === void 0 ? void 0 : _b[column]) !== null && _c !== void 0 ? _c : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "Selectable"), JSONSelectableType = (_f = (_e = (_d = config.types) === null || _d === void 0 ? void 0 : _d[rel.name]) === null || _e === void 0 ? void 0 : _e[column]) !== null && _f !== void 0 ? _f : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "JSONSelectable"), whereableType = (_j = (_h = (_g = config.types) === null || _g === void 0 ? void 0 : _g[rel.name]) === null || _h === void 0 ? void 0 : _h[column]) !== null && _j !== void 0 ? _j : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "Whereable"), insertableType = (_m = (_l = (_k = config.types) === null || _k === void 0 ? void 0 : _k[rel.name]) === null || _l === void 0 ? void 0 : _l[column]) !== null && _m !== void 0 ? _m : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "Insertable"), updatableType = (_q = (_p = (_o = config.types) === null || _o === void 0 ? void 0 : _o[rel.name]) === null || _p === void 0 ? void 0 : _p[column]) !== null && _q !== void 0 ? _q : (0, pgTypes_1.tsTypeForPgType)(udtName, enums, "Updatable");
        const columnDoc = createColumnDoc(config, schemaName, rel, row), schemaPrefix = config.unprefixedSchema === schemaName ? '' : `${schemaName}.`, prefixedRelName = schemaPrefix + rel.name, columnOptions = (_r = (config.columnOptions[prefixedRelName] && config.columnOptions[prefixedRelName][column])) !== null && _r !== void 0 ? _r : (config.columnOptions["*"] && config.columnOptions["*"][column]), isInsertable = rel.insertable && !isGenerated && (columnOptions === null || columnOptions === void 0 ? void 0 : columnOptions.insert) !== 'excluded', isUpdatable = rel.insertable && !isGenerated && (columnOptions === null || columnOptions === void 0 ? void 0 : columnOptions.update) !== 'excluded', insertablyOptional = isNullable || hasDefault || (columnOptions === null || columnOptions === void 0 ? void 0 : columnOptions.insert) === 'optional' ? '?' : '', orNull = isNullable ? ' | null' : '', orDefault = isNullable || hasDefault ? ' | db.DefaultType' : '', possiblyQuotedColumn = quoteIfIllegalIdentifier(column);
        // Now, 4 cases: 
